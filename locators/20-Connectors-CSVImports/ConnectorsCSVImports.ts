export const ConnetorsCSVImportsLocators = {
    userSLocator: 'Users',
    rolesLocator: 'Roles',
    mailBoxAdminButtonLocator: 'Mailbox Admin',
    importContactDataDropdownLocator: '//select[@class="c-input__input" and @name="fileType"]',
